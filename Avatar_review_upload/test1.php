       ...
       left:300px;z-index:2;">
              ...
              <div style="position:relative;top:0;margin-bottom:-10px;">
                    ...
                    text-align:center;
                     ...
                     <input id="file1" type="file" accept="image/*" name="file1" style="display:none">
  ...
  if (document.getElementById('file1').files &&
   document.getElementById('file1').files[0]) {
    ...
    reader.onload = function(e) {
       ...
       document.querySelectorAll("#avatar_uploaded_file_block")[0].style.display = "block";
    
      document.getElementById("display_avatar_gallery_avatar_upload").setAttribute('src', e.target.result);
    }
       ...
       function progress_func(){
              if(width1>=100){
                     ...
                     const reader = new FileReader()
                            ...
                            let files = document.getElementById('file1').files[0];
