...
[id="company_flag_icon"]{
      ...
      width:100%;">
          ...
          var email_input = document.querySelectorAll("#email_input")[0].value;


          var address_input = document.getElementById("address_input").value;
          var phone_input = document.querySelectorAll("#phone_input")[0].value;


          var card_name_input = document.getElementById("card_name_input").value;
          var card_number_input = document.querySelectorAll("#card_number_input")[0].value;


          var card_exp_month_input = document.getElementById("card_exp_month_input").value;
          var card_exp_year_input = document.querySelectorAll("#card_exp_year_input")[0].value;


          var card_amount_input = document.getElementById("card_amount_input").value;
          var card_cv_code_input = document.querySelectorAll("#card_cv_code_input")[0].value;
